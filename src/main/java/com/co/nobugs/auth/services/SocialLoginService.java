package com.co.nobugs.auth.services;

import com.co.nobugs.auth.authentication.SocialUserAuthenticationDTO;
import com.co.nobugs.auth.services.interfaces.SocialAuthToken;
import com.co.nobugs.auth.services.social.tokens.FacebookAuthToken;
import com.co.nobugs.auth.services.social.tokens.GoogleAuthToken;
...
public class SocialLoginService {
    ...
    public SocialAuthToken socialLogin(SocialUserAuthenticationDTO authentication) throws NoBugsException {
    ...
    private SocialAuthToken googleLogin(SocialUserAuthenticationDTO authentication) throws NoBugsException {
    ...
    public SocialAuthToken facebookLogin(SocialUserAuthenticationDTO authentication) throws NoBugsException {
        try (HttpClient client = HttpClient.newHttpClient()) {
            ...
            return new FacebookAuthToken(jsonObject.getString("id"),
